...
export default function GlobalReach() {
  ...
  // Core map dimensions references:
  // x and y percentages are set in data.ts for perfect responsive SVG overlay placement.
  ...
  return (
    <section id="global-reach" className="py-24 bg-cream-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Statistics highlights requested: 50+ Global Clients, 20+ Countries, 100+ Successful Shipments */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-white p-6 sm:p-8 rounded-xl border border-slate-200/80 shadow-sm flex items-center space-x-6 hover:shadow-md hover:border-gold-500/20 transition group">
            ...
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-wider text-slate-500 font-sans mt-1">Global Clients</p>
              <p className="text-[10px] text-slate-400 font-sans">Active Enterprise & Chain Buyers</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-xl border border-slate-200/80 shadow-sm flex items-center space-x-6 hover:shadow-md hover:border-gold-500/20 transition group">
            ...
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-wider text-slate-500 font-sans mt-1">Countries</p>
              <p className="text-[10px] text-slate-400 font-sans">Strict Regulatory Cleared Borders</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-xl border border-slate-200/80 shadow-sm flex items-center space-x-6 hover:shadow-md hover:border-gold-500/20 transition group">
            ...
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-wider text-slate-500 font-sans mt-1">Successful Shipments</p>
              <p className="text-[10px] text-slate-400 font-sans">Zero Cargo Delays or Rejections</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          <div className="lg:col-span-6">
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-sans font-light">
              We connect local Indian agricultural quality excellence with premium wholesale food traders and manufacturers globally. See our highlighted trade routes and ports of call where ADGROW GLOBAL ARYA supplies authentic cargo.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 relative min-h-[300px] sm:min-h-[400px] bg-navy-950 rounded-xl overflow-hidden border border-slate-800 flex items-center justify-center p-4">
              ...
              <div className="absolute bottom-4 left-4 text-[9px] text-slate-500 font-mono flex items-center gap-1.5 uppercase tracking-widest leading-none">
                <Waves className="w-3.5 h-3.5 text-gold-500/40" /> Sea Cargo Channels Activated
              </div>

              {/* Clean Map Graphic background - minimal abstract grid lines as a top-grade UI */}
              <svg
                viewBox="0 0 1000 500"
                className="w-full h-auto opacity-30 select-none pointer-events-none stroke-blue-800/20 fill-slate-800"
              >
                {/* Simplified continents paths to form a highly authentic high-contrast map backdrop */}
                ...
                {/* Abstract visual representations of major continents to serve as a beautiful aesthetic background */}
                {/* North America */}
              ...
              {EXPORT_COUNTRIES.map((country) => (
                ...
                >
                  ...
                  <div className={`absolute bottom-6 left-1/2 -translate-x-1/2 bg-navy-900 border border-gold-600/30 text-white p-3 rounded-lg shadow-xl text-center w-36 pointer-events-none transition-all duration-300 z-30 ${
                    ...
                    <p className="text-xs font-bold font-display uppercase tracking-wider text-gold-400">{country.name}</p>
                    <p className="text-[9px] text-slate-300 font-sans mt-1">Consignment Status:</p>
            ...
            <div className="lg:col-span-4 space-y-6">
              <h3 className="font-display font-bold text-lg text-white border-b border-white/10 pb-3 flex items-center gap-2">
                <Navigation className="w-5 h-5 text-gold-400" /> Primary Active Corridors
              </h3>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-navy-950/50 rounded-lg border border-slate-800/60 hover:border-gold-500/20 transition">
                  <div className="flex justify-between text-xs font-bold tracking-wider uppercase mb-1">
                    <span className="text-slate-300">Middle East & GCC</span>
                    <span className="text-gold-400">42% Volume</span>
                  </div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1.5 font-sans">Major products: Jaggery, Whole Spices, Staples</p>
                </div>

                <div className="p-4 bg-navy-950/50 rounded-lg border border-slate-800/60 hover:border-gold-500/20 transition">
                  <div className="flex justify-between text-xs font-bold tracking-wider uppercase mb-1">
                    <span className="text-slate-300">Europe & UK</span>
                    <span className="text-gold-400">28% Volume</span>
                  </div>
                  <div className="w-full bg-blue-950 h-1.5 rounded-full overflow-hidden">
                    <div className="bg-gold-500 h-full rounded-full" style={{ width: '28%' }} />
                  </div>
                  <p className="text-[10px] text-slate-500 mt-1.5 font-sans">Major products: Dehydrated Garlic/Onions, Kurkumin Turmeric</p>
                </div>

                <div className="p-4 bg-navy-950/50 rounded-lg border border-slate-800/60 hover:border-gold-500/20 transition">
                  <div className="flex justify-between text-xs font-bold tracking-wider uppercase mb-1">
                    <span className="text-slate-300">Asia-Pacific (APAC)</span>
                    <span className="text-gold-400">20% Volume</span>
                  </div>
                  <div className="w-full bg-blue-950 h-1.5 rounded-full overflow-hidden">
                    <div className="bg-gold-500 h-full rounded-full" style={{ width: '20%' }} />
                  </div>
                  <p className="text-[10px] text-slate-500 mt-1.5 font-sans">Major products: Quality Whole Grains, Ground Powders</p>
                </div>

                <div className="p-4 bg-navy-950/50 rounded-lg border border-slate-800/60 hover:border-gold-500/20 transition">
                  <div className="flex justify-between text-xs font-bold tracking-wider uppercase mb-1">
                    <span className="text-slate-300">Americas</span>
                    <span className="text-gold-400">10% Volume</span>
                  </div>
                  <div className="w-full bg-blue-950 h-1.5 rounded-full overflow-hidden">
                    <div className="bg-gold-500 h-full rounded-full" style={{ width: '10%' }} />
                  </div>
                  <p className="text-[10px] text-slate-500 mt-1.5 font-sans">Major products: Dehydrated Fruits, Organic Saffron</p>
                </div>
              </div>

              <div className="p-4 rounded-lg bg-gold-500/10 border border-gold-500/20 text-center">
                <p className="text-xs text-gold-400 font-semibold font-display tracking-wide uppercase">All ocean vessels trace live satellite tracking logs.</p>
                <p className="text-[10px] text-slate-400 mt-1">Insured by leading maritime underwriters.</p>
              </div>
            </div>
