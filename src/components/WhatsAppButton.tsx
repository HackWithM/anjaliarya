  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end pointer-events-none">
        ...
        {showTooltip && (
          ...
          >
            <div className="space-y-1">
              <p className="text-xs font-bold text-emerald-700 tracking-wide">{t('whatsapp.desk')}</p>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="pointer-events-auto relative flex h-14 w-14 items-center justify-center rounded-full bg-emerald-500 text-white hover:bg-emerald-600 shadow-2xl transition duration-300 group focus:outline-none cursor-pointer"
